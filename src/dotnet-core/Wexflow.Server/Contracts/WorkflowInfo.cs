...
namespace Wexflow.Server.Contracts
{
    ...
    public class WorkflowInfo:IComparable
    {
        ...
        public WorkflowInfo(string dbId, int id, string name, LaunchType launchType, bool isEnabled, bool isApproval, bool isWaitingForApproval, bool hasRestParams, string desc, bool isRunning, bool isPaused, string period, string cronExpression, bool isExecutionGraphEmpty, Variable[] localVariables)
        {
            DbId = dbId;
            Id = id;
            Name = name;
